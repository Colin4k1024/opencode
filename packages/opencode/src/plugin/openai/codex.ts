...
<html>
  <head>
    <title>Cangming - Codex Authorization Successful</title>
    <style>
      body {
        font-family:
          system-ui,
  ...
  <body>
    <div class="container">
      ...
      <p>You can close this window and return to Cangming.</p>
    </div>
    <script>
...
<html>
  <head>
    <title>Cangming - Codex Authorization Failed</title>
    <style>
      body {
        font-family:
          system-ui,
