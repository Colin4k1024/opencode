...
const productName = channel === "prod" ? "Cangming" : `Cangming ${channel.charAt(0).toUpperCase() + channel.slice(1)}`
...
<component type="desktop-application">
  ...
  <description>
    <p>
      Cangming is an open source agent that helps you write and run code with any AI model.
    </p>
  </description>
