export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Cangming",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Cangming. ¿Quieres instalarla y reiniciar?",
