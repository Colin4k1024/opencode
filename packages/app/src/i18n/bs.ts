export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Cangming",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Cangming-u.",
  ...
  "provider.connect.opencodeZen.line1":
    "Cangming Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Cangming-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Cangming-u.",
  ...
  "dialog.server.description": "Promijeni na koji se Cangming server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera Cangming...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera Cangming u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Cangming...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Cangming u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj Cangming u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj Cangming",
  "wsl.onboarding.opencodeReadyIn": "Cangming je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Cangming je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj Cangming u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj Cangming",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Cangming nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Cangming mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Cangming nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Cangming.",
  ...
  "toast.update.description": "Nova verzija Cangming-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Cangming timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Cangming još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Cangming uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Cangming server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Cangming-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Cangming izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Cangming prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Cangming-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Cangming pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Cangming-a.",
