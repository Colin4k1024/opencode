export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Cangming",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Cangming.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "Cangming Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Cangming.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Cangming.",
  ...
  "dialog.server.description": "Switch which Cangming server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Cangming...",
  "wsl.onboarding.checkingOpencodeIn": "Checking Cangming in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating Cangming...",
  "wsl.onboarding.updatingOpencodeIn": "Updating Cangming in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update Cangming in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Cangming",
  "wsl.onboarding.opencodeReadyIn": "Cangming is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Cangming is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Cangming in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Cangming",
  ...
  "toast.update.description": "A new version of Cangming ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Cangming team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Cangming does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Cangming includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the Cangming server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Cangming",
  ...
  "settings.general.row.appearance.description": "Customise how Cangming looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Cangming follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Cangming is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Cangming launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Cangming.",
