export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Cangming",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Cangming.",
  ...
  "provider.connect.opencodeZen.line1":
    "Cangming Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Cangming.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Cangming.",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Cangming se conecta esta app.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando Cangming...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando Cangming en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando Cangming...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando Cangming en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza Cangming en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar Cangming",
  "wsl.onboarding.opencodeReadyIn": "Cangming está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "Cangming está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala Cangming en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar Cangming",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Cangming no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Cangming pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Cangming no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Cangming.",
  ...
  "toast.update.description": "Una nueva versión de Cangming ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Cangming",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Cangming no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "Cangming incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Cangming dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Cangming",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Cangming en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Cangming sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Cangming.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Cangming",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Cangming.",
