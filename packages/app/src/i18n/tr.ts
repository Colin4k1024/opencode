...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Cangming tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Cangming'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.opencodeZen.line1":
    "Cangming Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Cangming'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Cangming'da {{provider}} modellerini kullanın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Cangming sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Cangming kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde Cangming kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "Cangming güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde Cangming güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki Cangming'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "Cangming'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde Cangming hazır.",
  "wsl.onboarding.opencodeReady": "Cangming hazır.",
  "wsl.onboarding.installOpencodeIn": "Cangming'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "Cangming'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Cangming kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cangming'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "Cangming bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Cangming'u tekrar açın.",
  ...
  "toast.update.description": "Cangming'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Cangming ekibine bildirin",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Cangming henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Cangming ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Cangming Masaüstü",
  ...
  "settings.desktop.wsl.description": "Cangming sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Cangming'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "Cangming'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Cangming'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Cangming'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Cangming başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Cangming'un en son sürümünü kullanıyorsunuz.",
