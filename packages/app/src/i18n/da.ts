export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Cangming",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Cangming.",
  ...
  "provider.connect.opencodeZen.line1":
    "Cangming Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Cangming.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Cangming.",
  ...
  "dialog.server.description": "Skift hvilken Cangming-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker Cangming...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker Cangming i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer Cangming...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer Cangming i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater Cangming i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater Cangming",
  "wsl.onboarding.opencodeReadyIn": "Cangming er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "Cangming er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer Cangming i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Cangming er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Cangming kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Cangming kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Cangming igen.",
  ...
  "toast.update.description": "En ny version af Cangming ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Cangming-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Cangming understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Cangming inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Cangming-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Cangming",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Cangming ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om Cangming følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Cangming er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Cangming starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Cangming.",
