export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Cangming",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Cangming.",
  ...
  "provider.connect.opencodeZen.line1":
    "Cangming Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Cangming.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Cangming.",
  ...
  "dialog.server.description": "Changez le serveur Cangming auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'Cangming...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'Cangming dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'Cangming...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'Cangming dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour Cangming dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour Cangming",
  "wsl.onboarding.opencodeReadyIn": "Cangming est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "Cangming est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez Cangming dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer Cangming",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Cangming non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Cangming puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Cangming n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Cangming.",
  ...
  "toast.update.description":
    "Une nouvelle version d'Cangming ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Cangming",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Cangming ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Cangming inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Cangming dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Cangming",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Cangming sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Cangming suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Cangming.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Cangming",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Cangming.",
