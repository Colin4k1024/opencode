...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Cangming",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Cangming zu nutzen.",
  ...
  "provider.connect.opencodeZen.line1":
    "Cangming Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in Cangming zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Cangming zu nutzen.",
  ...
  "dialog.server.description": "Wechseln Sie den Cangming-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.step.opencode": "Cangming",
  ...
  "wsl.onboarding.checkingOpencode": "Cangming wird geprüft...",
  "wsl.onboarding.checkingOpencodeIn": "Cangming in {{distro}} wird geprüft...",
  "wsl.onboarding.updatingOpencode": "Cangming wird aktualisiert...",
  "wsl.onboarding.updatingOpencodeIn": "Cangming in {{distro}} wird aktualisiert...",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie Cangming in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Cangming aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "Cangming ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "Cangming ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie Cangming in {{distro}}.",
  "wsl.onboarding.installOpencode": "Cangming installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Cangming nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Cangming einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Cangming konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Cangming erneut.",
  ...
  "toast.update.description": "Eine neue Version von Cangming ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Cangming-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Cangming unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "Cangming enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "Cangming Desktop",
  ...
  "settings.desktop.wsl.description": "Cangming-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Cangming ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Cangming auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Cangming dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Cangming anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Cangming automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von Cangming.",
