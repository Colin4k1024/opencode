export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Cangming",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Cangming.",
  ...
  "provider.connect.opencodeZen.line1":
    "Cangming Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Cangming.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Cangming.",
  ...
  "dialog.server.description": "Trocar para qual servidor Cangming este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o Cangming...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o Cangming em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o Cangming...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o Cangming em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o Cangming em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o Cangming",
  "wsl.onboarding.opencodeReadyIn": "O Cangming está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O Cangming está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o Cangming em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o Cangming",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Cangming não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Cangming possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Cangming não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Cangming novamente.",
  ...
  "toast.update.description": "Uma nova versão do Cangming ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Cangming",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Cangming ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Cangming inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Cangming dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Cangming",
  ...
  "settings.general.row.appearance.description": "Personalize como o Cangming aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Cangming segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Cangming é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Cangming iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Cangming.",
