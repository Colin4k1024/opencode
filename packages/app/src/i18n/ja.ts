export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Cangmingが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Cangmingで{{provider}}モデルを使用します。",
  ...
  "provider.connect.opencodeZen.line1":
    "Cangming Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してCangmingで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Cangmingで{{provider}}モデルを使用してください。",
  ...
  "dialog.server.description": "このアプリが接続するCangmingサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "Cangmingを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のCangmingを確認中...",
  "wsl.onboarding.updatingOpencode": "Cangmingを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のCangmingを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のCangmingを更新してください。",
  "wsl.onboarding.updateOpencode": "Cangmingを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のCangmingの準備ができました。",
  "wsl.onboarding.opencodeReady": "Cangmingの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にCangmingをインストールしてください。",
  "wsl.onboarding.installOpencode": "Cangmingをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Cangmingがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "CangmingでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、Cangmingをもう一度開いてください。",
  ...
  "toast.update.description": "Cangmingの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをCangmingチームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: CangmingはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Cangmingには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でCangmingサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Cangmingの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのCangmingの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Cangmingがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Cangmingのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Cangming の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Cangming は最新バージョンです。",
