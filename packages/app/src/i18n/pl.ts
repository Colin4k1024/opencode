export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Cangming",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Cangming.",
  ...
  "provider.connect.opencodeZen.line1":
    "Cangming Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Cangming.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Cangming.",
  ...
  "dialog.server.description": "Przełącz serwer Cangming, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie Cangming...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie Cangming w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie Cangming...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie Cangming w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj Cangming w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj Cangming",
  "wsl.onboarding.opencodeReadyIn": "Cangming jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Cangming jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj Cangming w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj Cangming",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Cangming nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Cangming będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Cangming nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Cangming.",
  ...
  "toast.update.description": "Nowa wersja Cangming ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Cangming",
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Cangming nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "Cangming zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Cangming wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Cangming",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Cangming na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Cangming ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Cangming.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Cangming",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Cangming.",
