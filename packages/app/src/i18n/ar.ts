export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Cangming",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Cangming.",
  ...
  "provider.connect.opencodeZen.line1":
    "يمنحك Cangming Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Cangming.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Cangming.",
  ...
  "dialog.server.description": "تبديل خادم Cangming الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من Cangming...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من Cangming في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث Cangming...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث Cangming في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث Cangming في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث Cangming",
  "wsl.onboarding.opencodeReadyIn": "Cangming جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "Cangming جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت Cangming في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت Cangming",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Cangming غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Cangming من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Cangming التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Cangming.",
  ...
  "toast.update.description": "نسخة جديدة من Cangming ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Cangming",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Cangming لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Cangming نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Cangming داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Cangming",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Cangming على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Cangming يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Cangming.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Cangming",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Cangming.",
