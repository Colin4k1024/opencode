...
- `Cangming` (preserve casing in prose, docs, and UI copy)
...
- Keep product naming consistent: `Cangming` in prose, `opencode` only for exact technical identifiers
...
- Avoid changing `opencode` to `Cangming` inside commands, URLs, package names, or code literals
